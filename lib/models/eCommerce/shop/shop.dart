...
class Shop {
  ...
  @override
  String toString() {
    return 'Shop(id: $id, name: $name, logo: $logo, banner: $banner, totalProducts: $totalProducts, totalCategories: $totalCategories, rating: $rating, shopStatus: $shopStatus, totalReviews: $totalReviews, isFollowed: $isFollowed)';
  }
